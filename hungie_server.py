        ...
        try:
            ...
            if is_recipe_request:
                ...
                if suggestions:
                    ...
                    ai_response = "I'd love to help you cook something delicious! Could you be more specific about what you're in the mood for? For example, tell me about ingredients you have, cuisine preferences, or cooking style. Yes, Chef! 🍴"
